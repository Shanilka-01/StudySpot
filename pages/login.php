...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $redirect = safe_redirect_target($_POST['redirect'] ?? null);
...
<div class="auth">
    <div class="auth__card">
        <p class="auth__logo"><img src="<?= asset('img/logo.png') ?>" alt="" width="30" height="30">
        ...
        <form method="post" action="<?= url('pages/login.php') ?>">
            ...
            <div class="field">
                <label for="password" style="display:flex;justify-content:space-between;">
                    Password <a href="<?= url('pages/help.php') ?>" style="color:var(--green-700);">Forgot Password?</a>
                </label>
        ...
        <p class="auth__foot">Don't have an account? <a href="<?= url('pages/register.php') ?>">Sign up</a></p>
