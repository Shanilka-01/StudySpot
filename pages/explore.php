...
function page_link(int $n): string
{
    $query = $_GET;
    $query['page'] = $n;
    return url('pages/explore.php') . '?' . http_build_query($query);
}
...
<div class="container page">
    ...
    <form method="get" action="<?= url('pages/explore.php') ?>" id="filterForm" style="margin:22px 0;">
        ...
        <div class="explore" style="margin-top:22px;">
            <!-- ---------- filters ---------- -->
            <aside class="filters">
                <h4>Filters <a href="<?= url('pages/explore.php') ?>">Clear All</a></h4>
                ...
                <?php foreach ($places as $p): ?>
                    <article class="result-row">
                        ...
                        <div class="result-row__info">
                            <h3><a href="<?= url('pages/place.php') ?>?id=<?= (int)$p['id'] ?>"><?= e($p['name']) ?></a></h3>
