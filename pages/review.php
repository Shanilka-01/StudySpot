...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        ...
        redirect('pages/place.php?id=' . $placeId);
        exit;
    }
}
...
<div class="container page">
    <p class="breadcrumb"><a href="<?= url('pages/place.php') ?>?id=<?= $placeId ?>">&larr; Back to <?= e($place['name']) ?></a></p>
    ...
    <div class="split">
        <div class="card card__pad">
            ...
            <form method="post" action="<?= url('pages/review.php') ?>">
        ...
        <aside class="guidelines">
            ...
            <img src="<?= asset('img/review-guide.png') ?>" alt="" class="guidelines__art">
        </aside>
    </div>
</div>
