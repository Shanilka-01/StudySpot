...
<div class="container page">
    ...
    <?php if (!$places): ?>
        <div class="card card__pad" style="margin-top:20px;">
            ...
            <a class="btn btn--sm" href="<?= url('pages/explore.php') ?>">Browse study spaces</a>
        </div>
    <?php endif; ?>
        ...
        <?php foreach ($places as $p): ?>
            <article class="fav-row">
                ...
                <form method="post" action="<?= url('pages/toggle-favorite.php') ?>">
                    ...
                    <input type="hidden" name="back" value="pages/favorites.php">
                    <button class="heart" type="submit" title="Remove from favourites">&#10084;</button>
                </form>
                <a class="btn btn--outline btn--sm" href="<?= url('pages/place.php') ?>?id=<?= (int)$p['id'] ?>">View</a>
            </article>
        <?php endforeach; ?>
    </div>
</div>
