...
if (!$booking) {
    ...
    redirect('pages/my-bookings.php');
    exit;
}
...
<div class="container page">
    <div class="confirm">
        ...
        <a class="btn btn--block" href="<?= url('pages/my-bookings.php') ?>">View My Bookings</a>
        <a class="btn btn--outline btn--block" style="margin-top:12px;" href="<?= url('index.php') ?>">Back to Home</a>
    </div>
</div>
